...
/* Keep your intended destination MAC here, in case of broadcast keep the destination address as 0xFF 0xFF 0xFF 0xFF 0xFF 0xFF*/
...
#define IF_NAME     "network_interface_name"
#define B_SIZE     2048
/* IP Header fields */
...
// Keep your device MAC address

        /* Source MAC address */
        sendbuf[tx_len++] = 0xXXC;
        sendbuf[tx_len++] = 0xXX;
        sendbuf[tx_len++] = 0xXX; 
        sendbuf[tx_len++] = 0xXX; 
        sendbuf[tx_len++] = 0xXX; 
